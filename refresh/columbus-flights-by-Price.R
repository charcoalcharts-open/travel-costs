...
flight=function(latx1,longx1,latx2,longx2,d1=Sys.Date()+2,d2=Sys.Date()+4,id=1,sort="Price"){
...
for(j in w) {f=rbind(f,flight(p$lat,p$long,d$lat[j],d$long[j],d$date[j]-1,d$date[j]+1,d$id[j],"Price"))
...
gh="https://api.github.com/repos/charcoalcharts-open/travel-costs/contents/data/upcoming-columbus-flights-by-price.csv"
